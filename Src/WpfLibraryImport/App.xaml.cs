...
using WpfLibraryImport.Views;

namespace WpfLibraryImport;
...
public partial class App : PrismApplication
{
    ...
    {
        // Core Services
        containerRegistry.RegisterSingleton<LegacyPInvokeSample>();
        containerRegistry.RegisterSingleton<ModernPInvokeSample>();
